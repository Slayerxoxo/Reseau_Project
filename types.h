...
enum bombState_t {IDLE, LAUNCHING, COUNTING1, COUNTING2, COUNTING3, COUNTING4, RED, EXPLODING};					// Etat d'une bombe: en attente d'être posée - vient juste d'être posée - posée - prête à exploser - en train d'exploser
